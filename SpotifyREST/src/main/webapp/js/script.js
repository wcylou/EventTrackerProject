...
function displayAllTrackers(trackers) {
	...
	for(let i = 0; i < trackers.length; i++) {
	    ...
	    tableRow2.addEventListener('click', function(e) {
	    	...
	    	var idRow = document.getElementById('trackerid');
		    idRow.textContent = 'Id: ' + trackers[i].id;
		    ...
		    updatebtn.addEventListener('click', function(e) {
		    	...
		    	xhr.onreadystatechange = function() {
		    		...
		    		if (xhr.readyState === 4 && xhr.status >= 400) {
		    			trackerInfoData.textContent = "tracker not created";
		    		}
		    	};
		    ...
		    deletebtn.addEventListener('click', function(e) {
		    	...
		    	xhr.onreadystatechange = function() {
		    		...
		    		if (xhr.readyState === 4 && xhr.status >= 400) {
		    			trackerInfoData.textContent = "tracker not deleted";
		    		}
		    	};
		    	xhr.send(null);
		    })
	    ...
	    tableData6.textContent = trackers[i].id;
